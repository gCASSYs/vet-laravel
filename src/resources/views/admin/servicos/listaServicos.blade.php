              ...
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.servicos.index') }}">Dashboard</a></li>
                      ...
                      {{--CONTEUDO DA TABELA--}}    
                        @forelse ($listaServicos as $servico)
                          <tr>
                            ...
                            {{--CATEGORIA SERVIÇO--}}
                            <td>
                              <span class="badge admin-record-label">{{ $servico->slug }}</span>
                            </td>
                            ...
                            {{--IMAGEM SERVIÇO--}}
                             <td>
                              @if ($servico->imagem)
                                <img
                                  src="{{ asset('vet/images/' . $servico->imagem) }}"
                                  alt="{{ $servico->nome }}"
                            ...
                            <td class="text-end">
                              <div class="btn-group btn-group-sm">
                                ...
                                <button
                                  ...
                                  data-bs-toggle="modal"
                                  data-bs-target="#modal-delete-servico"
                                  aria-label="DeletAR"
                                >
