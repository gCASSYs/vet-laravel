      ...
      <section class="admin-list-page">
        ...
        <div class="app-content-header admin-page-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Indicadores</h1>
              </div>
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.indicador.index') }}">Dashboard</a></li>
                ...
                <div class="card admin-data-card mb-4">
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      <div class="col-12 col-md-4">
                        <h3 class="card-title">Indicadores cadastrados</h3>
                      </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                              ...
                              aria-label="Pesquisar indicadores"
                            />
                          </div>
                          <select
                            id="indicador-role-filter"
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      ...
                      {{--CONTEUDO DA TABELA--}}    
                        @forelse ($listaIndicador as $indicador)
                          <tr>
                            {{--ID INDICADOR--}}
                            <td>
                            ...
                            {{--TITULO INDICADOR--}}
                            <td>
                              <span class="badge admin-record-label">{{ $indicador->titulo }}</span>
                            </td>
                            ...
                            {{--ORDEM DE EXIBIÇÃO INDICADOR--}}
                            <td>
                              {{ $indicador->ordem_exibicao }}
                            </td>
                          

                           {{--STATUS DO TITULO--}}
                            <td>
                              @if ($indicador->ativo == '1')
                            ...
                            <td class="text-end">
                              <div class="btn-group btn-group-sm">
                                ...
                                <button
                                  ...
                                  data-bs-toggle="modal"
                                  data-bs-target="#modal-delete-indicador"
                                  aria-label="DeletAR"
                                >
