              ...
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route('admin.banner.index') }}">Dashboard</a></li>
                      ...
                      {{--CONTEUDO DA TABELA--}}    
                        @forelse ($listaBanner as $banner)
                          <tr>
                            ...
                            {{--TITULO BANNER--}}
                            <td>
                              <span class="badge admin-record-label">{{ $banner->titulo }}</span>
                            </td>
                            ...
                            <td>
                              @if ($banner->imagem)
                                <img
                                  src="{{ asset('vet/images/' . $banner->imagem) }}"
                                  alt="{{ $banner->titulo }}"
